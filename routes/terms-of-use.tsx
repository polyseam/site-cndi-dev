  ...
  return (
    <div class="container-1264 mx-auto max-w-screen-lg">
      <p class="paragraph-26">
        ...
        <br />
        These Terms of Use form a legally binding contract between POLYSEAM DATA
        CORP. (&quot;we&quot; or &quot;us&quot;) and the people and companies
        (“Users” or “you”) that access and use our website located at cndi.run
        or any related website or mobile platform controlled by us
        (collectively, the &quot;Website&quot;). These Terms of Use apply to all
        services provided through our Website and any other software application
        ...
        Use before using the Website. By agreeing to these Terms of Use and
        using the Website, you are entering into a legally binding contract
        which will impact your rights.
        <br />
        <br />
        ...
        of these Terms of Use, then you may not access the Website or use any
        ...
        <br />
        2. Connect with users of the products
        <br />
        <br />
        The services we offer are subject to change over time. By using the
        Website, you are
        <br />
        confirming that you have determined that the services are appropriate
        for your needs. We do not guarantee that these services meet your needs
        ...
        text), POLYSEAM DATA CORP. does not review or pre-screen the contents of
        electronic data uploaded or posted to the Website (“Content”) and
        Polyseam Data Corp. claims no intellectual property rights with respect
        to the Content.
        <br />
        ‍<br />
        You grant to POLYSEAM DATA CORP. a non-exclusive, royalty-free right
        during your use of the Website, to use the Content for the sole purpose
        of performing POLYSEAM DATA CORP.’s obligations under these Terms of
        Use. Such rights shall include permission for POLYSEAM DATA CORP. to
        generate and publish aggregate, anonymized reports on system usage and
        Content trends.
        <br />
        <br />
        <strong class="privacy-heading">
        ...
        <br />
        You may cancel these Terms of Use at any time by discontinuing your use
        of the Website.
        <br />
        <br />
        <strong class="privacy-heading">
        ...
        resulting in any way from use of the Website.
        <br />
        <br />
        Your use of the Website is at your sole risk. The Website is provided on
        an “as is” and “as available” basis without any warranty or condition,
        express, implied or statutory. We do not warrant that your use of the
        Website will be uninterrupted, secure or error-free.
        <br />
        <br />
        In no event will we have any liability to you or any third party for any
        lost profits or
        <br />
        revenues or for any indirect, special, incidental, consequential, or
        punitive damages
        <br />
        however caused, whether in contract, tort, or otherwise, and whether or
        not you or the third party have been advised of the possibility of such
        damages. In the event the
        <br />
        foregoing paragraph, or any part thereof, is void under applicable law,
        ...
        <br />
        You agree to indemnify and hold harmless POLYSEAM DATA CORP., including
        ...
        the Website, including but not limited to your violation of any term of
        ...
        ensure that all usernames and passwords used to access the Website are
        ...
        determine in our sole discretion to be serious in nature, but we will
        not be held responsible or liable in any manner for breaches of security
        ...
        or statutory,
        <br />
        including but not limited to implied warranties as to merchantability or
        fitness for a<br />
        ...
        <br />
        <br />
        ii. Your use of the Website will be solely for purposes that are
        ...
        <br />
        <br />
        iv. Your use of the Website will comply with all local, provincial and
        federal laws, rules
        <br />
        ...
        posted on the Website. You may use the Website on behalf of others or in
        order to provide services to others but if you do so you must ensure
        ...
        over the age of 18. We do not target, market, or promote the Website to
        ...
        <br />
        ‍<br />
        If any claim, dispute or controversy occurs between POLYSEAM DATA CORP.
        and a User relating to the interpretation or implementation of any of
        the provisions of these Terms of Use, such dispute shall be resolved by
        ...
        agreement of the parties or, in the absence of an agreement, such
        arbitrator shall be appointed by a judge upon the application of either
        the User or POLYSEAM DATA CORP. Arbitration shall be held in the
        Province of Ontario, unless otherwise agreed by the parties. The
        arbitration procedure to be followed shall be agreed by the parties or,
        in absence of an agreement, determined by the arbitrator. The
        arbitration shall proceed in accordance with the provisions of the
        Arbitration Act, 1991, SO 1991, c 17. Subject to any right of appeal,
        ...
        ‍<br />
        By using the Website, you agree to resolve any claim or dispute arising
        ...
        commenced against POLYSEAM DATA CORP. or its affiliates related to any
        claim, dispute or controversy arising from your use of the Website.
        Where applicable, you hereby agree to opt out of any class proceeding
        against POLYSEAM DATA CORP. otherwise commenced.
        <br />
        <br />
        ...
        reserve the
        <br />
        right to change these Terms of Use at any time, and any amended Terms of
        Use are
        <br />
        effective upon posting to the Website. We will make efforts to
        communicate any
        <br />
        changes to these Terms of Use we deem material, in our sole discretion,
        via email or
        <br />
        notifications on the Website. Your continued use of the Website will be
        deemed to be
        <br />
        ...
        any person or
        <br />
        entity at any time with or without your consent and without prior notice
        to you.
        <br />
        <br />
        ...
        Terms of Use,
        <br />
        without our prior written consent, and any unauthorized assignment and
        delegation is
        <br />
        void.
        <br />
        ...
        operate as a waiver
        <br />
        of any other provision, right or remedy or the same provision, right or
        remedy on a<br />
        future occasion.
        <br />
        <br />
        ...
        not <br />
        partners or agents. POLYSEAM DATA CORP. has no fiduciary obligations or
        professional obligations whatsoever to you arising from these Terms of
        ...
        void or invalid
        <br />
        by a court of law, the remaining provisions, or parts thereof, shall be
        and remain in
        <br />
        ...
        available on the
        <br />
        Website (including but not limited to any Privacy Policy), incorporated
        by reference,
        <br />
        constitute the entire agreement between you and POLYSEAM DATA CORP. and
        <br />
        ...
        AND NOTICES POSTED ON THE WEBSITE.
      </p>
    </div>
  );
}
